...
start /b javaw -Dlogback.configurationFile="%USERPROFILE%/compendiumng_config/logback.xml" -Dcompendiumng.config.dir=${INSTALL_PATH}/data -Xmx512m -jar CompendiumNG.jar  %1 %2 %3 %4 %5 %6 %7 %8 %9
