...
start /b javaw -Dlogback.configurationFile="${INSTALL_PATH}\logback.xml.default" -Dcompendiumng.config.dir=${INSTALL_PATH}\config -Xmx512m -jar CompendiumNG.jar  %1 %2 %3 %4 %5 %6 %7 %8 %9
